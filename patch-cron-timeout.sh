...
docker exec "$CONTAINER" sed -i \
  ...
  /app/dist/reply-BHlTJvrR.js \
  /app/dist/loader-LsrpjvnK.js \
...
docker exec "$CONTAINER" sed -i \
  ...
  /app/dist/call-Bz1G7n-E.js \
  /app/dist/call-wsIAgrk7.js
...
docker exec "$CONTAINER" sed -i \
  ...
  /app/dist/gateway-cli-7cclFqa9.js \
  /app/dist/gateway-cli-Tyb6KTZP.js
