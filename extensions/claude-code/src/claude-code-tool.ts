...
export function createClaudeCodeTool(
  ...
  return {
    ...
    async execute(_id: string, params: Record<string, unknown>, _signal?: AbortSignal) {
        ...
        if (abortController.signal.aborted) {
          ...
          return {
            content: [
              {
                type: "text" as const,
                text: JSON.stringify(timeoutDetails, null, 2),
              },
            ],
            details: timeoutDetails as Record<string, unknown>,
          };
        }
