...
export default function register(api: OpenClawPluginApi) {
  ...
  const rootDir = api.rootDir ?? "/tmp/openclaw";
  const workspaceMediaDir = path.join(rootDir, "media", "selfies");
            ...
            content: [
              {
                ...
                text: [
                  ...
                  "",
                  "",
                  `To deliver this selfie, include the following line in your reply text:`,
                  `MEDIA:${filePath}`,
                  `Then write your caption on a separate line. The system extracts the MEDIA: line and attaches the image automatically.`,
                  `Do NOT call the message tool — just include MEDIA:${filePath} in your text output.`,
                ].join("\n"),
              },
            ],
          };
